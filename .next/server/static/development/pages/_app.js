...
/* harmony import */ var sal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! sal.js */ "sal.js");
...
function App({
  ...
  react__WEBPACK_IMPORTED_MODULE_2___default.a.useEffect(() => {
    document.querySelectorAll(".notion-h1").forEach(heading => {
      if (heading.querySelectorAll(".mask").length == 0) heading.innerHTML = heading.innerHTML.replace(/[A-Za-z0-9\-_.,!?äöüßÄÖÜ]+/g, `<span class="mask"><span class="text">$&</span></span>`);
    });
    console.log("effect");
